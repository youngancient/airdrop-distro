...
3. **Update the CSV file and Configure the Script**
...
The command above deploys the contract with the id: Airdrop-deployment. We can easily verify the contract by running
...
7. **Assumptions and Limitations**
   - **Assumptions**
     ...
     - The contract owner is fair enough to allow at least 51% of airdrops to be claimed before withdrawing all the tokens from the contract.
   - **Limitations**
     - This contract can only be used by one airdrop claiming project at a particular time, i.e. only one token can be sent and airdropped.
