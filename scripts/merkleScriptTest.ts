...
import {
  AirdropEntity,
  generateMerkleTree,
  generateMerkleTreeFromAddresses,
} from "./merkleScript";
...
function test2() {
  ...
  const leaf = keccak256("address"); // Replace "address" with the actual leaf value

  const target = output[0];
  const address = target.address;
  const proof = target.proofs;
...
function test() {
  const entities: AirdropEntity[] = [
    ...
    {
      address: "0x9a3a60f5aee7aef1fb0d4da8534452a2e2a89d46",
      amount: "100000000000000000000",
    },
    {
      address: "0xf5ab70ada82e7260a4e09d79b8e09bd2fc08970c",
    ...
    {
      address: "0xc8211f26bb21afc25bb784208a63d96deaae55cb",
      amount: "210000000000000000000",
    },
    {
      address: "0xf9056af4cd1211dd9638e9979e99a43de830779e",
      amount: "320000000000000000000",
    },
  ];
  const { output, rootHash, proofs } = generateMerkleTree(entities);
